...
public class PointCloudRenderer {
    ...
    public void createOnGlThread(Context context) {
        ShaderUtils.Companion.checkGLError(TAG, "before create");
        ...
        ShaderUtils.Companion.checkGLError(TAG, "buffer alloc");

        int vertexShader =
                ShaderUtils.Companion.loadShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.point_cloud_vertex);
        ...
        ShaderUtils.Companion.checkGLError(TAG, "program");
        ...
        ShaderUtils.Companion.checkGLError(TAG, "program  params");
    }
    ...
    public void update(PointCloud cloud) {
        ...
        ShaderUtils.Companion.checkGLError(TAG, "before update");
        ...
        ShaderUtils.Companion.checkGLError(TAG, "after update");
    }
    ...
    public void draw(float[] cameraView, float[] cameraPerspective) {
        ...
        ShaderUtils.Companion.checkGLError(TAG, "Before draw");
