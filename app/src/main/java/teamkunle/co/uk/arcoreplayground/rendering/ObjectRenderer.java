...
public class ObjectRenderer {
    ...
    public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
        ...
        ShaderUtils.Companion.checkGLError(TAG, "OBJ buffer load");

        final int vertexShader =
                ShaderUtils.Companion.loadShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.object_vertex);
        final int fragmentShader =
                ShaderUtils.Companion.loadShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, R.raw.object_fragment);
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity) {
        ...
        ShaderUtils.Companion.checkGLError(TAG, "After draw");
    }
